               ...
               <h1 className="title-h1 mb-4 md:mb-6 text-3xl sm:text-4xl md:text-[32px] lg:text-6xl leading-tight">
                 ...
                 <span className="text-primary">
                   Every Life Deserves a Way Out
                             ...
                             {/* Description */}
               <p className="title-h3 mb-6 md:mb-8 text-base sm:text-lg md:text-xl leading-relaxed w-full sm:w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3" style={{ color: 'rgba(23, 33, 54, 0.8)' }}>
